...
def maus(wavfile, text, language='aus', canonly=False,
         minpauslen=5, startword=0, endword=999999, mausshift=10,
         insprob=0.0, insortextgrid=True, inskantextgrid=True):
...
MausException: Internal Server Error
    ...
    params = dict((('LANGUAGE', language),
                ...
                ('INSORTTEXTGRID', maus_boolean(insortextgrid)),
                ('INSKANTEXTGRID', maus_boolean(inskantextgrid)),
                ('MINPAUSLEN', str(minpauslen)),
